---
name: penalista-strategia
description: "Analisi difensiva di capi di imputazione e costruzione della strategia di difesa penale italiana. ATTIVARE SEMPRE quando l'avvocato porta un capo di imputazione, una CNR (comunicazione notizia di reato), un'ordinanza cautelare, un'informazione di garanzia, o chiede 'come mi difendo', 'analizza questa accusa', 'che strategia adottiamo', 'come impugniamo', 'c'e spazio per'. Attivare anche quando si discute di elementi costitutivi di un reato, eccezioni processuali, riti alternativi applicabili, calcolo prescrizione in chiave difensiva, o improcedibilita Cartabia come strumento difensivo. Questa skill e il cuore del lavoro del penalista — usarla ogni volta che si entra nel merito di un fascicolo penale."
---
...
**Termine di prescrizione / improcedibilità**
→ Vedi sezione 7.
...
**Strategia A — Difesa nel merito (proscioglimento pieno)**
Perseguibile se ci sono reali lacune probatorie o giuridiche. Indica su quali elementi concentrare la battaglia.

**Strategia B — Riqualificazione del fatto**
Se il reato contestato può essere degradato a fattispecie meno grave (es. corruzione → istigazione alla corruzione; omicidio doloso → omicidio preterintenzionale o colposo; bancarotta fraudolenta → bancarotta semplice). Indica la qualificazione alternativa e l'argomento giuridico.

**Strategia C — Rito alternativo**
Valuta se conviene:
...
**Strategia D — Difesa in attenuazione**
Se la condanna è probabile, concentrarsi sulla minimizzazione della pena: circostanze attenuanti (art. 62 c.p.), attenuanti generiche (art. 62-bis), continuazione (art. 81 co. 2), risarcimento del danno, condotte riparatorie.
...
- Suggerisci i tag giurisprudenziali da salvare in `penalista-giurisprudenza/`
- Aggiorna o crea la voce in `SCADENZIARIO.md` per le scadenze identificate
